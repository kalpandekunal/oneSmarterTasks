      ...
      <Box mt={"100px"}>
        <Box className="about-flex">
          <Box  className="bigbasket">
            <Text fontSize={18} color="#800000">KNOW US</Text>
            <Text className="hover">About Essentials</Text>
            <Text className="hover">Blog</Text>
          </Box>

          <Box className="help">
            <Text className="text-color" fontSize={18} color="#800000">HELPDESK</Text>
        ...
        <Box className="about-flex-2">
          ...
          <Box className="P-options">
            <Text fontSize={18}  color="red">PAYMENT OPTIONS:</Text>
        ...
        <Box w="100%" bg="black" h="50px" alignContent="center">
